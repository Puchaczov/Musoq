...
public class RewriteWhereExpressionToPassItToDataSourceTests : BasicEntityTestBase
{
    ...
    {
        var query =
            "select 1 from #A.entities() a inner join #B.entities() b on a.City = b.City where a.Population > 0";
    ...
    {
        var query =
            "select 1 from #A.entities() a inner join #B.entities() b on a.City = b.City where a.Population > b.Population";
    ...
    {
        var query =
            "select 1 from #A.entities() a inner join #B.entities() b on a.City = b.City inner join #C.entities() c on b.City = c.City where a.Population > b.Population and c.Population = 200d";
