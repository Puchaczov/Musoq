...
public class HashJoinIntegrationTests : MultiSchemaTestBase
{
    ...
    {
        const string query =
            "select first.FirstItem, second.FirstItem from #schema.first() first left outer join #schema.second() second on first.FirstItem = second.FirstItem order by first.FirstItem";
    ...
    {
        const string query =
            "select first.FirstItem, second.FirstItem from #schema.first() first right outer join #schema.second() second on first.FirstItem = second.FirstItem order by second.FirstItem";
