...
```powershell
dotnet test src\dotnet\Musoq.Evaluator.Tests\Musoq.Evaluator.Tests.csproj -c Release --no-build --collect:"XPlat Code Coverage"
```

Latest recorded coverage run:

- Result: 10004 passed, 4 intentionally skipped refresh utilities.
- Cobertura artifact: `src/dotnet/Musoq.Evaluator.Tests/TestResults/c01fbdaa-8fab-475b-9a50-18ed2b61fc25/coverage.cobertura.xml`
- Overall line-rate: `0.8110`; evaluator assembly line-rate: `0.8596`.
- Overall branch-rate: `0.6972`; evaluator assembly branch-rate: `0.7569`.
- The evaluator assembly improved from the pre-roadmap baseline of `0.8551` line / `0.7532` branch.

Latest Plugins-focused coverage run:

- Result: 4743 passed, 0 skipped.
- Cobertura artifact: `src/dotnet/Musoq.Plugins.Tests/TestResults/611a3c5e-3124-44ad-a0a4-648079da6309/coverage.cobertura.xml`
- Plugins assembly line-rate: `0.8057`; branch-rate: `0.8197`.
- The Plugins assembly improved from the pre-roadmap focused baseline of `0.7251` line / `0.7320` branch.
...
- Latest result: 18353 passed, 4 intentionally skipped refresh utilities (Parser 1962, Schema 471, Evaluator 10004, Converter 1025, Plugins 4743, CSV examples 49, Git examples 45, Benchmarks 54).
...
- Executable feature ledger: `specs/feature-coverage.json` records stable feature ids, owners, runtime status, documentation, and evidence requirements. Compiled MSTest methods carry `FeatureEvidenceAttribute`; the validator rejects unknown statuses, duplicate ids, missing documentation, missing executable evidence, and any attempt to normalize a specification mismatch into a passing status.
