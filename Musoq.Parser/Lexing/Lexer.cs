...
public class Lexer : LexerBase<Token>
{
    ...
    private TokenType GetTokenCandidate(string tokenText, string regex)
    {
        ...
        switch (loweredToken)
        {
            ...
            case IsToken.TokenText:
                return TokenType.Is;
            case MethodsToken.TokenText:
                return TokenType.Methods;
    ...
    public static class TokenRegexDefinition
    {
        ...
        public static readonly string KMethods = Format(Keyword, MethodsToken.TokenText);
    ...
    private static class DefinitionSets
    {
        ...
        [
            ...
            new(TokenRegexDefinition.KMethods),
    ...
    protected override Token GetToken(TokenDefinition matchedDefinition, Match match)
    {
        ...
        switch (token)
        {
            ...
            case TokenType.Methods:
                return new MethodsToken(new TextSpan(Position, tokenText.Length));
            case TokenType.Null:
