...
namespace GeneratedSample_P07_ParallelCte_Full
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable, IProfiledRunnable
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        var cteLevel0Runner = new CteLevel0Runner(provider, sourceRuntimeSettingsBySourceContextId, sourceExecutionPlans, logger, token, OnDataSourceProgress, profileRecorder, OnPhaseChanged, _cteRowResults, _cteIndexResults);
        ...
        private sealed class CteLevel0Runner
        {
            ...
            {
                Task0Result = BuildCteLevel0Task0(_provider, _sourceRuntimeSettingsBySourceContextId, _sourceExecutionPlans, _logger, _token, _onDataSourceProgress, _profileRecorder, _onPhaseChanged, _cteRowResults, _cteIndexResults);
            }

            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public void RunCteLevel0Task1()
            {
                Task1Result = BuildCteLevel0Task1(_provider, _sourceRuntimeSettingsBySourceContextId, _sourceExecutionPlans, _logger, _token, _onDataSourceProgress, _profileRecorder, _onPhaseChanged, _cteRowResults, _cteIndexResults);
            }
        }
