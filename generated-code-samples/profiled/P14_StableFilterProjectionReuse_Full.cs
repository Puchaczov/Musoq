...
/*
MultiStatement
  Project [ko3iko.Name as Name, ko3iko.Population as Population, (ko3iko.Population * 2) as Twice]
...
PhysicalMultiStatement
  PhysicalProject [ko3iko.Name as Name, ko3iko.Population as Population, (ko3iko.Population * 2) as Twice]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ChunkedForEach [ko3iko in ko3ikoRows]
      ...
      If [(population > 0)]
        AppendShape [result <- ResultShape0(Name: ko3iko.Name, Population: population, Twice: (population * 2))]
...
// === SyntaxTree:  ===
namespace GeneratedSample_P14_StableFilterProjectionReuse_Full
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable, IProfiledRunnable
    {
        private static readonly Column[] __columns_compiled_result_1 = new Column[]
        {
            ...
            new Column("Twice", typeof(decimal), 2)
        };
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.Name, __musoqShapeRow.Population, __musoqShapeRow.Twice);
            }
        }
                    ...
                    if (ko3ikoChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> ko3ikoChunkView)
                    {
                        if (ko3ikoChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] ko3ikoChunkViewArray)
                        {
                            ...
                            for (int ko3ikoIndex = 0, ko3ikoIndexCount = ko3ikoChunkView.Count; ko3ikoIndex < ko3ikoIndexCount; ++ko3ikoIndex)
                            {
                                ...
                                if ((population > 0))
                                {
                                    yield return new ResultShape0(ko3iko.Name, population, (population * 2));
                                }
                            }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0_Profiled(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token, QueryProfileRecorder profileRecorder)
        {
            ...
            try
            {
                ...
                var __op17Handle = profileRecorder?.GetOperatorHandle("op17", "ChunkedForEach") ?? OperatorProfileHandle.None;
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            public decimal Twice { get; private set; }
        ...
        {
            public ResultShape0(string Name, decimal Population, decimal Twice)
            {
                this.Name = Name;
