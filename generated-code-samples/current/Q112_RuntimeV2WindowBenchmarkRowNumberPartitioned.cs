...
MultiStatement
  Project [ko3iko.Name as Name, ko3iko.Department as Department, WindowRef(0) as rn]
    Window [RowNumber(idx:0; partition: ko3iko.Department; order: ko3iko.Salary DESC)]
...
PhysicalMultiStatement
  PhysicalProject [ko3iko.Name as Name, ko3iko.Department as Department, WindowRef(0) as rn]
    PhysicalWindow [RowNumber(idx:0; partition: ko3iko.Department; order: ko3iko.Salary DESC)]
      PhysicalMaterialize
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ComputeRowNumberWindow [resultRowNumbers <- resultWindowRows partition by ko3iko.Department order by ko3iko.Salary DESC]
    CreateShapeRows [result: ResultShape0 from ResultRow0]
    PhaseBoundary [Select]
    ForEachIndexed [windowIndex, ko3iko in resultWindowRows]
      AppendShape [result <- ResultShape0(Name: ko3iko.Name, Department: ko3iko.Department, rn: resultRowNumbers[windowIndex])]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q112_RuntimeV2WindowBenchmarkRowNumberPartitioned
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
                {
                    ...
                    __musoqFinalShapeRows.Add(new ResultShape0(ko3iko.Name, ko3iko.Department, (long)resultRowNumbers[windowIndex]));
                }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static void ExtractResultRowNumbersWindowKeys(IReadOnlyList<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2RegressionEntity> resultWindowRows, string[] resultRowNumbersPartitionKeys, WindowResultRowNumbersOrderKeysKey[] resultRowNumbersOrderKeys)
        {
            for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
            {
                Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2RegressionEntity ko3iko = resultWindowRows[windowIndex];
                resultRowNumbersPartitionKeys[windowIndex] = (string)ko3iko.Department;
