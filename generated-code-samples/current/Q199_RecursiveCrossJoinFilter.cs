// === Parsed Query ===
/*
with recursive reachable (Id, Depth) as (select RootId, 0 from #graph.roots() union (Id) select e.TargetId, r.Depth + 1 from reachable r cross join #graph.edges() e where e.SourceId = r.Id) select Id, Depth from reachable order by Id
*/
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q199_RecursiveCrossJoinFilter
{
    using System;
