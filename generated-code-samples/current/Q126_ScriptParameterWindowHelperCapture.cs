...
// === SyntaxTree:  ===
namespace GeneratedSample_Q126_ScriptParameterWindowHelperCapture
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable
    {
        ...
        public IReadOnlyList<ScriptParameterContract> ParameterContracts { get; } = new ScriptParameterContract[]
        {
            ...
            new ScriptParameterContract("label", "string", "string", typeof(string), false, false, null, null, false, ScriptParameterDefaultKind.None, null)
        };
        public IReadOnlyList<ScriptParameterDefinition> ParameterDefinitions { get; } = new ScriptParameterDefinition[]
        {
            ...
            new ScriptParameterDefinition(new ScriptParameterContract("label", "string", "string", typeof(string), false, false, null, null, false, ScriptParameterDefaultKind.None, null))
        };
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                var paramLabel = ScriptParameterBinder.GetRequired<string>(__musoqExecutionState.Parameters, "label");
                ScriptParameterBinder.ValidateNoUnknownParameters(__musoqExecutionState.Parameters, new string[] { "country", "label" });
                ...
                ExtractResultRowNumbersWindowKeys(resultWindowRows, resultRowNumbersPartitionKeys, resultRowNumbersOrderKeys, paramCountry, paramLabel);
                ...
                for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
                {
                    ...
                    __musoqFinalShapeRows.Add(new ResultShape0(ko3iko.Name, (long)resultRowNumbers[windowIndex], paramLabel));
                }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static void ExtractResultRowNumbersWindowKeys(IReadOnlyList<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> resultWindowRows, string[] resultRowNumbersPartitionKeys, WindowResultRowNumbersOrderKeysKey[] resultRowNumbersOrderKeys, string paramCountry, string paramLabel)
        {
            for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
            {
                Musoq.Evaluator.Tests.Schema.Basic.BasicEntity ko3iko = resultWindowRows[windowIndex];
