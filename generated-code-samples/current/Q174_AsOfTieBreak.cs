...
MultiStatement
  ...
  Project [a.Name as a.Name, b.Name as b.Name, b.Money as b.Money]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  ...
  PhysicalProject [a.Name as a.Name, b.Name as b.Name, b.Money as b.Money]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateAsOfIndex [resultAsOfIndex <- bRows by bCandidate.Population; tie bCandidate.Money DESC NULLS LAST]
    ChunkedForEach [a in aRows]
      AsOfProbe [b <- bRows using resultAsOfIndex where a.Population >= bCandidate.Population tie break by bCandidate.Money DESC NULLS LAST]
...
namespace GeneratedSample_Q174_AsOfTieBreak
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        private static readonly Column[] __columns_compiled_result_2 = new Column[]
        {
            ...
            new Column("b.Money", typeof(decimal), 2)
        };
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_a_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0), new Column("Population", typeof(decimal), 1) });
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_b_1 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0), new Column("Population", typeof(decimal), 1), new Column("Money", typeof(decimal), 2) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_Name, __musoqShapeRow.b_Name, __musoqShapeRow.b_Money);
            }
        }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultAsOfIndex = EvaluationHelper.CreateAsOfIndex<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity, decimal, decimal>(bRows, null, (bCandidate) => bCandidate.Population, Musoq.Evaluator.IR.Expressions.BinaryOpKind.GreaterOrEqual, (bCandidate) => bCandidate.Money, true, Musoq.Evaluator.IR.Bindings.NullOrdering.Last);
                            ...
                            if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                            {
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    var a = aChunkViewArray[aChunkViewOffset + aIndex];
                                    {
                                        ...
                                        if (b != null)
                                        {
                                            __musoqFinalShapeRows.Add(new ResultShape0(a.Name, b.Name, b.Money));
                                        }
                                    }
                                }
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            public decimal b_Money { get; private set; }
            ...
            public override object this[string name] => name switch
            {
                ...
                "b.Money" => (object)b_Money,
                "b_Money" => (object)b_Money,
                "Money" => (object)b_Money,
        ...
        {
            public ResultShape0(string a_Name, string b_Name, decimal b_Money)
            {
                this.a_Name = a_Name;
                this.b_Name = b_Name;
