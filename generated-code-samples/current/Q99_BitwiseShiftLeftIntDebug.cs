...
namespace GeneratedSample_Q99_BitwiseShiftLeftIntDebug
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_ko3iko_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0), new Column("City", typeof(string), 1), new Column("Country", typeof(string), 2), new Column("Population", typeof(decimal), 3), new Column("Self", typeof(Musoq.Evaluator.Tests.Schema.Basic.BasicEntity), 4), new Column("Money", typeof(decimal), 5), new Column("Month", typeof(string), 6), new Column("Time", typeof(DateTime), 7), new Column("Id", typeof(int), 8), new Column("NullableValue", typeof(int?), 9), new Column("Array", typeof(int[]), 10), new Column("Other", typeof(Musoq.Evaluator.Tests.Schema.Basic.BasicEntity), 11), new Column("Dictionary", typeof(Dictionary<string, string>), 12), new Column("Children", typeof(Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[]), 13) });
