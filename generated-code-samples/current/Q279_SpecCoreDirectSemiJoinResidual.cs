...
MultiStatement
  Project [a.Name as a.Name]
    Join [LeftSemi] [((a.Id = b.Id) AND (b.Population > 100))]
...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name]
    PhysicalHashJoin [LeftSemi] [build: b.Id] [probe: a.Id] [residual: (b.Population > 100)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q279_SpecCoreDirectSemiJoinResidual
{
    using System;
