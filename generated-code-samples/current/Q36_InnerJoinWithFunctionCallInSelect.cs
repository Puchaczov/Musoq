// === Parsed Query ===
/*
select ToUpper(a.Name), b.Country from #A.entities() a inner join #A.entities() b on a.Id = b.Id
*/
...
MultiStatement
  ...
  Project [ToUpper(a.Name) as ToUpper(a.Name), b.Country as b.Country]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  ...
  PhysicalProject [ToUpper(a.Name) as ToUpper(a.Name), b.Country as b.Country]
    ...
    ChunkedForEach [a in aRows]
      HashProbe [bHash[a.Id] -> bHashMatches]
        ForEach [b in bHashMatches]
          AppendShape [result <- ResultShape0(ToUpper(a.Name): ToUpper(a.Name), b.Country: b.Country)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q36_InnerJoinWithFunctionCallInSelect
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_b_1 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Country", typeof(string), 0), new Column("Id", typeof(int), 1) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.ToUpper_a_Name_, __musoqShapeRow.b_Country);
            }
        }
                            ...
                            if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                            {
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    if (bHash.TryGetValue(key, out var bHashMatches))
                                    {
                                        ...
                                        {
                                            token.ThrowIfCancellationRequested();
                                            __musoqFinalShapeRows.Add(new ResultShape0((string)__resultLibraryBase0.ToUpper(a.Name), b.Country));
                                        }
                                    }
                                }
        ...
        {
            public ResultShape0(string ToUpper_a_Name_, string b_Country)
            {
