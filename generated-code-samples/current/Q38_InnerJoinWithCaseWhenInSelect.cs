...
namespace GeneratedSample_Q38_InnerJoinWithCaseWhenInSelect
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_a_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Population", typeof(decimal), 0), new Column("Id", typeof(int), 1) });
