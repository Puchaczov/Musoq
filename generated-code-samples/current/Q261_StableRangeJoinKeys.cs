...
MultiStatement
  Project [a.Name as a.Name, a.Population as a.Population, b.Name as b.Name, b.Population as b.Population, b.Money as b.Money]
    Join [Inner] [((a.Population >= b.Population) AND (a.Population <= b.Money))]
...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name, a.Population as a.Population, b.Name as b.Name, b.Population as b.Population, b.Money as b.Money]
    PhysicalSortMergeJoin [Inner] [left: a.Population] [right: b.Population] [op: >=] [residual: ((a.Population >= b.Population) AND (a.Population <= b.Money))]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateRangeIndex [resultRangeIndex <- bRows by bRangeCandidate.Population >=]
    ChunkedForEach [a in aRows]
      RangeProbe [b <- resultRangeIndex where a.Population]
        Let [population: decimal = a.Population]
        If [((population >= b.Population) AND (population <= b.Money))]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q261_StableRangeJoinKeys
{
    using System;
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultRangeIndex = EvaluationHelper.CreateRangeJoinIndex<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity, decimal>(bRows, (bRangeCandidate) => bRangeCandidate.Population, Musoq.Evaluator.IR.Expressions.BinaryOpKind.GreaterOrEqual);
                        ...
                        if (aChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> aChunkView)
                        {
                            if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                            {
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    foreach (var b in resultRangeIndex.Find(a.Population))
                                    {
                                        decimal population = a.Population;
                                        if (((population >= b.Population) && (population <= b.Money)))
                                        {
