...
/*
MultiStatement
  Project [(ko3iko.Population * 2) as ResidualPopulation, ko3iko.Name as Name]
...
PhysicalMultiStatement
  PhysicalProject [(ko3iko.Population * 2) as ResidualPopulation, ko3iko.Name as Name]
...
ExecutionPlan [compiled]
  Shapes
    ...
    Generated [ResultRow0]
      ResidualPopulation: decimal <- field ResidualPopulation
  ...
  Body
    ...
    ChunkedForEach [ko3iko in ko3ikoRows]
      ...
      If [(population > 0)]
        AppendShape [result <- ResultShape0(ResidualPopulation: (population * 2), Name: ko3iko.Name)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q266_SourceComputedProjectionResidual
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        {
            new Column("ResidualPopulation", typeof(decimal), 0),
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.ResidualPopulation, __musoqShapeRow.Name);
            }
        }
                    ...
                    if (ko3ikoChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> ko3ikoChunkView)
                    {
                        if (ko3ikoChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] ko3ikoChunkViewArray)
                        {
                            ...
                            for (int ko3ikoIndex = 0, ko3ikoIndexCount = ko3ikoChunkView.Count; ko3ikoIndex < ko3ikoIndexCount; ++ko3ikoIndex)
                            {
                                ...
                                if ((population > 0))
                                {
                                    yield return new ResultShape0((population * 2), ko3iko.Name);
                                }
                            }
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            {
                ResidualPopulation = __value0;
                Name = __value1;
            }

            public override int Count => 2;
            public string Name { get; private set; }
            public decimal ResidualPopulation { get; private set; }
            ...
            public override void AssignValue(int columnNumber, object value)
            {
                ...
                {
                    case 0:
                        ResidualPopulation = (decimal)value;
                        break;
                    case 1:
                        Name = (string)value;
                        break;
            ...
            {
                0 => (object)ResidualPopulation,
                1 => (object)Name,
                _ => throw new IndexOutOfRangeException()
            };
            public override object this[string name] => name switch
            {
                "ResidualPopulation" => (object)ResidualPopulation,
                "Name" => (object)Name,
        ...
        {
            public ResultShape0(decimal ResidualPopulation, string Name)
            {
                this.ResidualPopulation = ResidualPopulation;
                this.Name = Name;
            }

            public string Name { get; }
            public decimal ResidualPopulation { get; }
        }
    }
}
