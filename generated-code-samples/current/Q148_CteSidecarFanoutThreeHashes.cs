    ...
    ParallelBlock [cte-level-0, tasks 3, maxDegree 3]
      ...
      ParallelTask [cities -> __parallelCteLevel0Task1Result]
        ...
        ChunkedForEach [vo04qt in cte1_vo04qtRows]
          Let [id: int = vo04qt.Id]
          CreateHashPayload [cte1SidecarPayload0 <- Cte1HashPayload1(Id: id, City: vo04qt.City)]
          HashAdd [cte1HashSidecar1Id[id] += cte1SidecarPayload0]
      ...
      ParallelTask [countries -> __parallelCteLevel0Task2Result]
        ...
        ChunkedForEach [gougbq in cte2_gougbqRows]
          Let [id: int = gougbq.Id]
          CreateHashPayload [cte2SidecarPayload0 <- Cte2HashPayload2(Id: id, Country: gougbq.Country)]
          HashAdd [cte2HashSidecar2Id[id] += cte2SidecarPayload0]
...
namespace GeneratedSample_Q148_CteSidecarFanoutThreeHashes
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_gougbq_2 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Country", typeof(string), 0), new Column("Id", typeof(int), 1) });
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_ko3iko_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0), new Column("Id", typeof(int), 1) });
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_vo04qt_1 = Array.AsReadOnly(new ISchemaColumn[] { new Column("City", typeof(string), 0), new Column("Id", typeof(int), 1) });
                    ...
                    if (vo04qtChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> vo04qtChunkView)
                    {
                        if (vo04qtChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] vo04qtChunkViewArray)
                        {
                            ...
                            for (int vo04qtIndex = 0, vo04qtIndexCount = vo04qtChunkView.Count; vo04qtIndex < vo04qtIndexCount; ++vo04qtIndex)
                            {
                                ...
                                int id = vo04qt.Id;
                                Cte1HashPayload1 cte1SidecarPayload0 = new Cte1HashPayload1(id, vo04qt.City);
                                int cte1HashSidecar1IdKey0 = id;
                                {
                    ...
                    if (gougbqChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> gougbqChunkView)
                    {
                        if (gougbqChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] gougbqChunkViewArray)
                        {
                            ...
                            for (int gougbqIndex = 0, gougbqIndexCount = gougbqChunkView.Count; gougbqIndex < gougbqIndexCount; ++gougbqIndex)
                            {
                                ...
                                int id = gougbq.Id;
                                Cte2HashPayload2 cte2SidecarPayload0 = new Cte2HashPayload2(id, gougbq.Country);
                                int cte2HashSidecar2IdKey0 = id;
                                {
