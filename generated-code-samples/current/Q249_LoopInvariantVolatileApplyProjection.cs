...
/*
MultiStatement
  Project [a.VolatileValue as a.VolatileValue, a.Middles as a.Middles, b.Value as b.Value, b.Leaves as b.Leaves]
    Apply [Cross]
      SchemaScan [#licm.outers() as a]
      PropertySource [a.Middles as b] [apply: Cross] [type: LoopInvariantSampleMiddle[]]
  Project [ab.a.VolatileValue as a.VolatileValue, ab.a.Middles as a.Middles, ab.b.Value as b.Value, ab.b.Leaves as b.Leaves, c.Value as c.Value]
    Apply [Cross]
      CteRef [ab as ab]
      PropertySource [ab.b.Leaves as c] [apply: Cross] [type: LoopInvariantSampleLeaf[]]
  Project [a.VolatileValue as a.VolatileValue, b.Value as b.Value, c.Value as c.Value]
    CteRef [abc as abc]
*/
...
PhysicalMultiStatement
  PhysicalProject [a.VolatileValue as a.VolatileValue, a.Middles as a.Middles, b.Value as b.Value, b.Leaves as b.Leaves]
  ...
  PhysicalProject [ab.a.VolatileValue as a.VolatileValue, ab.a.Middles as a.Middles, ab.b.Value as b.Value, ab.b.Leaves as b.Leaves, c.Value as c.Value]
    PhysicalNestedLoopApply [Cross]
      PhysicalCteRef [ab as ab]
      PhysicalPropertySource [ab.b.Leaves as c] [apply: Cross] [type: LoopInvariantSampleLeaf[]]
  PhysicalProject [a.VolatileValue as a.VolatileValue, b.Value as b.Value, c.Value as c.Value]
...
ExecutionPlan [compiled]
  Shapes
    ...
    Generated [Statement0Row0]
      ...
      b.Leaves: LoopInvariantSampleLeaf[] <- field b_Leaves
    TableRow [ab]
      a.VolatileValue: int <- field a_VolatileValue
      a.Middles: LoopInvariantSampleMiddle[] <- field a_Middles
      b.Value: int <- field b_Value
      b.Leaves: LoopInvariantSampleLeaf[] <- field b_Leaves
    SourceEntity [c: LoopInvariantSampleLeaf]
      Id: int <- property Id
      Value: int <- property Value
    Generated [ResultRow0]
      a.VolatileValue: int <- field a_VolatileValue
      b.Value: int <- field b_Value
      c.Value: int <- field c_Value
  ...
  Body
    ...
    ChunkedForEach [a in statement0_aRows]
      ...
      ChunkedForEach [b in statement0_bRows]
        AppendRow [statement0 <- Statement0Row0(a.VolatileValue: a.VolatileValue, a.Middles: a.Middles, b.Value: b.Value, b.Leaves: b.Leaves)]
    ...
    ForEach [ab in _cteRowResults.Slot0]
      Let [abaVolatileValue: int = ab.a.VolatileValue]
      Let [abbValue: int = ab.b.Value]
      EnumerableSource [ab.b.Leaves -> cRows]
      ChunkedForEach [c in cRows]
        AppendShape [result <- ResultShape0(a.VolatileValue: abaVolatileValue, b.Value: abbValue, c.Value: c.Value)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q249_LoopInvariantVolatileApplyProjection
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        private static readonly Column[] __columns_compiled_result_2 = new Column[]
        {
            ...
            new Column("c.Value", typeof(int), 2)
        };
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_a_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("VolatileValue", typeof(int), 0), new Column("Middles", typeof(Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleMiddle[]), 1) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_VolatileValue, __musoqShapeRow.b_Value, __musoqShapeRow.c_Value);
            }
        }
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (int __storedTable0Index = 0; __storedTable0Index < __storedTable0Rows.Count; ++__storedTable0Index)
                    {
                        ...
                        int abaVolatileValue = ab.a_VolatileValue;
                        int abbValue = ab.b_Value;
                        var cRows = EvaluationHelper.ConvertEnumerableOutputToChunks<Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf>(ab.b_Leaves);
                        foreach (var cChunk in cRows)
                        {
                            if (cChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf> cChunkView)
                            {
                                if (cChunkView.Source is Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf[] cChunkViewArray)
                                {
                                    ...
                                    for (int cIndex = 0, cIndexCount = cChunkView.Count; cIndex < cIndexCount; ++cIndex)
                                    {
                                        ...
                                        __musoqFinalShapeRows.Add(new ResultShape0(abaVolatileValue, abbValue, c.Value));
                                    }

                                    continue;
                                }

                                if (cChunkView.Source is List<Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf> cChunkViewList)
                                {
                                    int cChunkViewOffset = cChunkView.Offset;
                                    for (int cIndex = 0, cIndexCount = cChunkView.Count; cIndex < cIndexCount; ++cIndex)
                                    {
                                ...
                                if (bChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleMiddle> bChunkView)
                                {
                                    if (bChunkView.Source is Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleMiddle[] bChunkViewArray)
                                    {
                                        ...
                                        for (int bIndex = 0, bIndexCount = bChunkView.Count; bIndex < bIndexCount; ++bIndex)
                                        {
                                            ...
                                            statement0.Add(new Statement0Row0(a.VolatileValue, a.Middles, b.Value, b.Leaves));
                                        }
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            public int c_Value { get; private set; }
            ...
            public override object this[string name] => name switch
            {
                ...
                "c.Value" => (object)c_Value,
                "c_Value" => (object)c_Value,
        ...
        {
            public ResultShape0(int a_VolatileValue, int b_Value, int c_Value)
            {
        ...
        {
            public Statement0Row0(int __value0, Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleMiddle[] __value1, int __value2, Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf[] __value3)
            {
                a_VolatileValue = __value0;
                a_Middles = __value1;
                b_Value = __value2;
            ...
            public int a_VolatileValue { get; }
            public Musoq.Evaluator.Tests.Schema.Generated.LoopInvariantSampleLeaf[] b_Leaves { get; }
            public int b_Value { get; }
        }
    }
}
