...
// === SyntaxTree:  ===
namespace GeneratedSample_Q127_ScriptParameterParallelHelperCapture
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_ko3iko_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0), new Column("Value", typeof(int), 1) });
        public ILogger Logger { get; set; }
        public IReadOnlyList<ScriptParameterContract> ParameterContracts { get; } = new ScriptParameterContract[]
        {
            new ScriptParameterContract("threshold", "int", "int", typeof(int), false, false, null, null, false, ScriptParameterDefaultKind.None, null),
        ...
        {
            new ScriptParameterDefinition(new ScriptParameterContract("threshold", "int", "int", typeof(int), false, false, null, null, false, ScriptParameterDefaultKind.None, null)),
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            var paramThreshold = ScriptParameterBinder.GetRequired<int>(__musoqExecutionState.Parameters, "threshold");
            var paramLabel = ScriptParameterBinder.GetRequired<string>(__musoqExecutionState.Parameters, "label");
            ScriptParameterBinder.ValidateNoUnknownParameters(__musoqExecutionState.Parameters, new string[] { "threshold", "label" });
