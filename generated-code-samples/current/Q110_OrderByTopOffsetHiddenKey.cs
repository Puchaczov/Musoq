...
MultiStatement
  Take [3]
    Skip [1]
      Sort [(ko3iko.Population + ko3iko.Money) DESC]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateBoundedRecordList [resultOrderRecords: ResultRow0WithSortKeys by __sortKey0 DESC, skip 1, take 3]
    ChunkedForEach [ko3iko in ko3ikoRows]
      AppendRecord [resultOrderRecords <- ResultRow0WithSortKeys(Name: ko3iko.Name, __sortKey0: (ko3iko.Population + ko3iko.Money))]
...
namespace GeneratedSample_Q110_OrderByTopOffsetHiddenKey
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_ko3iko_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 10), new Column("Population", typeof(decimal), 13), new Column("Money", typeof(decimal), 15) });
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                var resultOrderRecords = new EvaluationHelper.BoundedTopRecordList<ResultRow0WithSortKeys>(1, 3, ResultRow0WithSortKeysComparer.Instance);
                    ...
                    if (ko3ikoChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> ko3ikoChunkView)
                    {
                        if (ko3ikoChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] ko3ikoChunkViewArray)
                        {
                            ...
                            for (int ko3ikoIndex = 0, ko3ikoIndexCount = ko3ikoChunkView.Count; ko3ikoIndex < ko3ikoIndexCount; ++ko3ikoIndex)
                            {
                                ...
                                resultOrderRecords.Add(new ResultRow0WithSortKeys(ko3iko.Name, (ko3iko.Population + ko3iko.Money), resultOrderRecords.Count));
                            }
                ...
                {
                    __musoqFinalShapeRows.Add(new ResultShape0(resultRecord.Name));
                }
        ...
        {
            public ResultRow0WithSortKeys(string Name, decimal __sortKey0, int __ordinal)
            {
                this.Name = Name;
