    ...
    RecursiveCte [counter; result cte0; frontiers cte0CurrentFrontier, cte0NextFrontier; identity none; max iterations 1000; max rows 10000000; max snapshot rows 10000000]
      Anchor
        ...
        ForEach [seed in cte0CurrentFrontier_seedRows]
          RecursiveAppend [cte0CurrentFrontier <- Cte0Row0(Value: 1); identity none; guard cte0.Count + cte0CurrentFrontier.Count < 10000000]
      RecursiveMember
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q219_RecursiveLimitDefaultCodeShape
{
    using System;
