...
MultiStatement
  ...
  Project [a.Name as a.Name, b.Name as OtherName]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  ...
  PhysicalProject [a.Name as a.Name, b.Name as OtherName]
...
ExecutionPlan [compiled]
  Shapes
    ...
    Generated [ResultRow0]
      ...
      OtherName: string <- field OtherName
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q20_OuterApply
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        private static readonly Column[] __columns_compiled_result_1 = new Column[]
        {
            ...
            new Column("OtherName", typeof(string), 1)
        };
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_a_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 0) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_Name, __musoqShapeRow.OtherName);
            }
        }
        ...
        {
            public ResultShape0(string a_Name, string OtherName)
            {
                this.a_Name = a_Name;
