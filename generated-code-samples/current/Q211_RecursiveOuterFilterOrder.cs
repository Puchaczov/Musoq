...
Cte
  ...
  Query
    MultiStatement
      Sort [walk.Depth DESC]
        Project [walk.Id as Id, walk.Depth as Depth]
          Filter [(walk.Depth > 0)]
            CteRef [walk as walk]
*/
...
PhysicalCte
  ...
  Query
    PhysicalMultiStatement
      PhysicalSort [walk.Depth DESC]
        PhysicalProject [walk.Id as Id, walk.Depth as Depth]
          PhysicalFilter [(walk.Depth > 0)]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ForEach [walk in _cteRowResults.Slot0]
      ...
      If [(depth > 0)]
        AppendShape [result <- ResultShape0(Id: walk.Id, Depth: depth)]
    SortShapeRows [result -> resultSorted by Depth DESC]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q211_RecursiveOuterFilterOrder
{
    using System;
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                for (int __storedTable0Index = 0; __storedTable0Index < __storedTable0Rows.Count; ++__storedTable0Index)
                {
                    ...
                    if ((depth > 0))
                    {
                        result.Add(new ResultShape0(walk.Id, depth));
                    }
                }
