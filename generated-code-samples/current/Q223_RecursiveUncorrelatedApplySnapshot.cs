// === Parsed Query ===
/*
with recursive reachable (Id, Depth) as (select RootId, 0 from #graph.roots() union (Id) select e.TargetId, r.Depth + 1 from reachable r cross apply #graph.edges() e where e.SourceId = r.Id) select Id, Depth from reachable order by Id
*/
      ...
      RecursiveMember
        PhysicalMultiStatement
          ...
          PhysicalProject [e.TargetId as e.TargetId, (r.Depth + 1) as r.Depth + 1]
            PhysicalFilter [(e.SourceId = r.Id)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q223_RecursiveUncorrelatedApplySnapshot
{
    using System;
