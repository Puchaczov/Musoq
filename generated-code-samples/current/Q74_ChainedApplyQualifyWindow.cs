...
MultiStatement
  Sort [i.Name]
    Project [i.Name as i.Name, n.Value as FirstValue, m.Value as SecondValue]
...
PhysicalMultiStatement
  PhysicalSort [i.Name]
    PhysicalProject [i.Name as i.Name, n.Value as FirstValue, m.Value as SecondValue]
  ...
  Body
    ...
    ForEachIndexed [windowIndex, apply_0_i_n_m in resultWindowRows]
      If [((resultRowNumbers[windowIndex] > 0) AND (resultRowNumbers[windowIndex] <= 1))]
        AppendShape [result <- ResultShape0(i.Name: apply_0_i_n_m.i.Name, FirstValue: apply_0_i_n_m.n.Value, SecondValue: apply_0_i_n_m.m.Value)]
    SortShapeRows [result -> resultSorted by i.Name ASC]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q74_ChainedApplyQualifyWindow
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.i_Name, __musoqShapeRow.FirstValue, __musoqShapeRow.SecondValue);
            }
        }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
                {
                    ...
                    {
                        result.Add(new ResultShape0(apply_0_i_n_m.i_Name, apply_0_i_n_m.n_Value, apply_0_i_n_m.m_Value));
                    }
                }
        ...
        {
            public ResultShape0(string i_Name, int FirstValue, int SecondValue)
            {
                this.i_Name = i_Name;
