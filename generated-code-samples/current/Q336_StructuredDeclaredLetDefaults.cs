...
MultiStatement
  Project [m.PatternId as m.PatternId, m.MatchText as m.MatchText]
    SchemaScan [#inputs.match('TODO ISSUE-42', <IReadOnlyList`1>$patterns) as m]
*/
...
PhysicalMultiStatement
  PhysicalProject [m.PatternId as m.PatternId, m.MatchText as m.MatchText]
    PhysicalSchemaScan [#inputs.match('TODO ISSUE-42', <IReadOnlyList`1>$patterns) as m]
*/
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q336_StructuredDeclaredLetDefaults
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                __musoqStructuralCarrier_0_a[] letPatterns = new __musoqStructuralCarrier_0_a[]
                {
                    new __musoqStructuralCarrier_0_a("todo", "TODO", "regex", 7UL),
                    new __musoqStructuralCarrier_0_a("issue", "ISSUE-[0-9]+", "regex", 7UL)
                };
                OnPhaseChanged("compiled", QueryPhase.Begin);
                IReadOnlyList<Musoq.Examples.DataSources.StructuredInputs.PatternInput> __musoqStructural_m_0 = __musoqStructuralAdapt_0_691781520(letPatterns);
                ...
                try
                {
                    Musoq.Examples.DataSources.StructuredInputs.MatchSource mRowsSourceInstance = new Musoq.Examples.DataSources.StructuredInputs.MatchSource("TODO ISSUE-42", __musoqCheckStructural_9a1ccaa9c485de38(__musoqStructural_m_0, token), mRowsSourceContext);
