...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ChunkedForEach [ko3iko in ko3ikoRows]
      AppendRecord [resultOrderRecords <- ResultRow0WithSortKeys(Name: ko3iko.Name, WeightedPopulation: (ko3iko.Population * 2))]
    OrderRecordList [resultOrderRecords: ResultRow0WithSortKeys by WeightedPopulation DESC, Name ASC]
...
namespace GeneratedSample_Q93_OrderByAlias
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.Name, __musoqShapeRow.WeightedPopulation);
            }
        }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                    ...
                    if (ko3ikoChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> ko3ikoChunkView)
                    {
                        if (ko3ikoChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] ko3ikoChunkViewArray)
                        {
                            ...
                            for (int ko3ikoIndex = 0, ko3ikoIndexCount = ko3ikoChunkView.Count; ko3ikoIndex < ko3ikoIndexCount; ++ko3ikoIndex)
                            {
                                ...
                                resultOrderRecords.Add(new ResultRow0WithSortKeys(ko3iko.Name, (ko3iko.Population * 2), resultOrderRecords.Count));
                            }
                ...
                {
                    __musoqFinalShapeRows.Add(new ResultShape0(resultRecord.Name, resultRecord.WeightedPopulation));
                }
        ...
        {
            public ResultRow0WithSortKeys(string Name, decimal WeightedPopulation, int __ordinal)
            {
                this.Name = Name;
        ...
        private sealed class ResultRow0WithSortKeysComparer : IComparer<ResultRow0WithSortKeys>
        {
            ...
            {
                var comparison = left.WeightedPopulation.CompareTo(right.WeightedPopulation);
        ...
        {
            public ResultShape0(string Name, decimal WeightedPopulation)
            {
                this.Name = Name;
                this.WeightedPopulation = WeightedPopulation;
            }
