// === Parsed Query ===
/*
select a.Name, a.City, b.Country, b.Population from #A.entities() a left outer join #A.entities() b on a.Id = b.Id
*/

// === Logical Plan ===
/*
MultiStatement
  Project [a.Name as a.Name, a.City as a.City, a.Id as a.Id, b.Country as b.Country, b.Population as b.Population, b.Id as b.Id]
    Join [LeftOuter] [(a.Id = b.Id)]
      SchemaScan [#A.entities() as a]
      SchemaScan [#A.entities() as b]
  Project [a.Name as a.Name, a.City as a.City, b.Country as b.Country, b.Population as b.Population]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name, a.City as a.City, a.Id as a.Id, b.Country as b.Country, b.Population as b.Population, b.Id as b.Id]
    PhysicalHashJoin [LeftOuter] [build: b.Id] [probe: a.Id]
      PhysicalSchemaScan [#A.entities() as a]
      PhysicalSchemaScan [#A.entities() as b]
  PhysicalProject [a.Name as a.Name, a.City as a.City, b.Country as b.Country, b.Population as b.Population]
    ...
    ChunkedForEach [a in aRows]
      HashProbe [bHash[a.Id] -> bHashMatches] [match: bHashHasMatch]
        ForEach [b in bHashMatches]
          ...
          AppendShape [result <- ResultShape0(a.Name: a.Name, a.City: a.City, b.Country: b.Country, b.Population: b.Population)]
      HashProbeNoMatch
        AppendShape [result <- ResultShape0(a.Name: a.Name, a.City: a.City, b.Country: NULL, b.Population: NULL)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q35_LeftJoinWithMultipleColumns
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_a_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 10), new Column("City", typeof(string), 11), new Column("Id", typeof(int), 18) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_Name, __musoqShapeRow.a_City, __musoqShapeRow.b_Country, __musoqShapeRow.b_Population);
            }
        }
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    if (key != null && bHash.TryGetValue(key, out var bHashMatches))
                                    {
                                        foreach (var b in bHashMatches)
                                        {
                                            token.ThrowIfCancellationRequested();
                                            bHashHasMatch = true;
                                            __musoqFinalShapeRows.Add(new ResultShape0(a.Name, a.City, b.Country, b.Population));
                                        }
                                    }

                                    if (!bHashHasMatch)
                                    {
                                        __musoqFinalShapeRows.Add(new ResultShape0(a.Name, a.City, null, null));
                                    }
                                }
        ...
        {
            public ResultShape0(string a_Name, string a_City, string b_Country, decimal? b_Population)
            {
                this.a_Name = a_Name;
                this.a_City = a_City;
