// === Parsed Query ===
/*
desc #A.entities() column Children
*/
...
// === Physical Plan ===
/*
PhysicalDesc [#A.entities()] [Column] [Children]
*/
...
ExecutionPlan [compiled]
  ...
  Body
    PhaseBoundary [Begin]
    ReturnDesc [#A.entities() Column column Children]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q296_SpecCoreDescColumn
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private Table ComputeTable_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            var schemaTable = descSchema.GetTableByName("entities", descRuntimeCtx, Array.Empty<object>());
            try
            {
            ...
            return EvaluationHelper.GetSpecificColumnDescription(schemaTable, "Children", new Musoq.Parser.TextSpan(26, 8));
