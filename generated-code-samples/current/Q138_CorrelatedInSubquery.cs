...
Cte
  Definition [_sq_1]
    MultiStatement
      Project [b.City as City, b.Country as _sq_1_corr_0]
        SchemaScan [#B.entities() as b]
  Query
    MultiStatement
      Project [a.City as a.City]
        Join [LeftSemi] [((a.City = _sq_1.City) AND (_sq_1._sq_1_corr_0 = a.Country))]
...
PhysicalCte
  Definition [_sq_1]
    PhysicalMultiStatement
      PhysicalProject [b.City as City, b.Country as _sq_1_corr_0]
        PhysicalSchemaScan [#B.entities() as b]
  Query
    PhysicalMultiStatement
      PhysicalProject [a.City as a.City]
        PhysicalHashJoin [LeftSemi] [build: _sq_1.City, _sq_1._sq_1_corr_0] [probe: a.City, a.Country]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateKeySet [_sq_1Keys: ValueTuple<string, string>]
    ChunkedForEach [b in cte0_bRows]
      KeySetAdd [_sq_1Keys += (b.City, b.Country)]
    PhaseBoundary [Select]
    ChunkedForEach [a in aRows]
      KeySetProbe [_sq_1Keys[(a.City, a.Country)]]
                    ...
                    if (aChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> aChunkView)
                    {
                        if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                        {
                            ...
                            for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                            {
                                ...
                                var key1 = a.Country;
                                var key = (key0, key1);
                                if (key0 != null && key1 != null && _sq_1Keys.Contains(key))
                                {
