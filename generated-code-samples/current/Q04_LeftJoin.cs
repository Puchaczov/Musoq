// === Parsed Query ===
/*
select a.Name, b.Country from #A.entities() a left outer join #A.entities() b on a.Id = b.Id
*/
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ChunkedForEach [a in aRows]
      ...
      HashProbeNoMatch
        AppendShape [result <- ResultShape0(a.Name: a.Name, b.Country: NULL)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q04_LeftJoin
{
    using System;
