...
MultiStatement
  Project [n.Value as n.Value]
    SchemaScan [#inputs.numbers(array { 1, 2, 2, 3 }) as n]
*/
...
PhysicalMultiStatement
  PhysicalProject [n.Value as n.Value]
    PhysicalSchemaScan [#inputs.numbers(array { 1, 2, 2, 3 }) as n]
*/
...
ExecutionPlan [compiled]
  ...
  Body
    PhaseBoundary [Begin]
    Let [__musoqStructural_n_0: IReadOnlyList<int> = array { 1, 2, 2, 3 }]
    PhaseBoundary [From]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q330_StructuredPrimitiveArray
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                var nRowsSourceContext = new SourceExecutionContext("n:1", sourceExecutionPlans["n:1"], token, __schemaColumns_compiled_n_0, sourceRuntimeSettingsBySourceContextId["n:1"], logger, OnDataSourceProgress);
                Musoq.Schema.DataSources.RowSource<Musoq.Examples.DataSources.StructuredInputs.NumberRow> nRowsSource;
                try
                {
                    Musoq.Examples.DataSources.StructuredInputs.NumbersSource nRowsSourceInstance = new Musoq.Examples.DataSources.StructuredInputs.NumbersSource(__musoqCheckStructural_25b8ff93e4648a1e(__musoqStructural_n_0, token), nRowsSourceContext);
                    nRowsSource = DataSourceLifecycle.OpenTypedRowSource<Musoq.Examples.DataSources.StructuredInputs.NumbersSource, Musoq.Examples.DataSources.StructuredInputs.NumberRow>(__nSchema, "numbers", nRowsSourceInstance, nRowsSourceContext, "#inputs", "n", "n:1");
                }
                ...
                var nRows = __musoqProgressContext != null ? QueryProgressRuntime.WrapChunks<Musoq.Examples.DataSources.StructuredInputs.NumberRow>(nRowsSource.Chunks, __musoqProgressContext, "n:1") : nRowsSource.Chunks;
        ...
        private static IReadOnlyList<int> __musoqCheckStructural_25b8ff93e4648a1e(IReadOnlyList<int> value, System.Threading.CancellationToken token)
        {
            token.ThrowIfCancellationRequested();
            ...
            global::Musoq.Evaluator.Helpers.StructuralInputLimitRuntime.ThrowIfExceeded("inline", "n.argument[0]", new global::Musoq.Schema.StructuralInputs.StructuralInputMetrics(__musoqStructuralMaxDepth, __musoqStructuralNodes, __musoqStructuralStrings), 32, 100000L, 67108864L, token, "n:1");
            return value;
        }
