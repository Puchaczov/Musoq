...
// === Logical Plan ===
/*
Desc [#A.entities()] [Settings] []
*/

// === Physical Plan ===
/*
PhysicalDesc [#A.entities()] [Settings] []
*/
...
ExecutionPlan [compiled]
  ...
  Body
    PhaseBoundary [Begin]
    ReturnDesc [#A.entities() Settings]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q298_SpecCoreDescSettings
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private Table ComputeTable_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            return EvaluationHelper.GetSourceRuntimeSettingsDescription(SourceRuntimeSettingDescriptionsBySourceContextId.TryGetValue("df8apb:1", out var descSourceRuntimeSettingDescriptions) ? descSourceRuntimeSettingDescriptions : Array.Empty<SourceRuntimeSettingDescription>(), token);
