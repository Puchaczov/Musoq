...
MultiStatement
  Project [m.PatternId as m.PatternId]
    SchemaScan [#inputs.match('TODO', array { (Id: 'todo', Pattern: 'TODO') }) as m]
*/
...
PhysicalMultiStatement
  PhysicalProject [m.PatternId as m.PatternId]
    PhysicalSchemaScan [#inputs.match('TODO', array { (Id: 'todo', Pattern: 'TODO') }) as m]
*/
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    Let [__musoqStructural_m_3: IReadOnlyList<PatternInput> = array { __musoqStructural_m_2 }]
    PhaseBoundary [From]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q349_StructuredCoupledSource
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                IReadOnlyList<Musoq.Examples.DataSources.StructuredInputs.PatternInput> __musoqStructural_m_3 = new Musoq.Examples.DataSources.StructuredInputs.PatternInput[]
                {
                ...
                try
                {
                    Musoq.Examples.DataSources.StructuredInputs.MatchSource mRowsSourceInstance = new Musoq.Examples.DataSources.StructuredInputs.MatchSource("TODO", __musoqCheckStructural_389b095bd9c4e750(__musoqStructural_m_3, token), mRowsSourceContext);
                    ...
                    if (mChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Examples.DataSources.StructuredInputs.PatternMatchRow> mChunkView)
                    {
                        if (mChunkView.Source is Musoq.Examples.DataSources.StructuredInputs.PatternMatchRow[] mChunkViewArray)
                        {
                            ...
                            for (int mIndex = 0, mIndexCount = mChunkView.Count; mIndex < mIndexCount; ++mIndex)
                            {
                                ...
                                __musoqFinalShapeRows.Add(new ResultShape0(m.PatternId));
                            }
