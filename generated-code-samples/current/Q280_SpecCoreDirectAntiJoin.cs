...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateKeySet [bKeys: int]
    ChunkedForEach [b in bRows]
      KeySetAdd [bKeys += b.Id]
    PhaseBoundary [Select]
    ChunkedForEach [a in aRows]
      KeySetProbe [bKeys[a.Id]] [match: bKeysHasMatch]
        Assign [bKeysHasMatch = TRUE]
      KeySetProbeNoMatch
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q280_SpecCoreDirectAntiJoin
{
    using System;
