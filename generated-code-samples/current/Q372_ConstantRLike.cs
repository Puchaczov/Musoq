...
MultiStatement
  Sort [ko3iko.Id]
    Project [ko3iko.Id as Id, ko3iko.Name as Name]
      Filter [ko3iko.Name RLIKE '\A[A-Z][a-z]+\z']
...
PhysicalMultiStatement
  PhysicalSort [ko3iko.Id]
    PhysicalProject [ko3iko.Id as Id, ko3iko.Name as Name]
      PhysicalFilter [ko3iko.Name RLIKE '\A[A-Z][a-z]+\z']
...
ExecutionPlan [compiled]
  ...
  Body
    PhaseBoundary [Begin]
    Let [__rlikeMatcher0: PreparedRLikeMatcher = PREPARE_RLIKE('\A[A-Z][a-z]+\z', strategy=regex, anchors=none, literal-span=none, fallback=RegexMetacharacter)]
    PhaseBoundary [From]
    ...
    ChunkedForEach [ko3iko in ko3ikoRows]
      ...
      If [PREPARED_RLIKE(name, __rlikeMatcher0)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q372_ConstantRLike
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                Musoq.Evaluator.PreparedRLikeMatcher __rlikeMatcher0 = Operators.PrepareRLike("\\A[A-Z][a-z]+\\z");
                    ...
                    if (ko3ikoChunk is global::Musoq.Schema.DataSources.RowChunk<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity> ko3ikoChunkView)
                    {
                        if (ko3ikoChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] ko3ikoChunkViewArray)
                        {
                            ...
                            for (int ko3ikoIndex = 0, ko3ikoIndexCount = ko3ikoChunkView.Count; ko3ikoIndex < ko3ikoIndexCount; ++ko3ikoIndex)
                            {
                                ...
                                if (Operators.RLikePrepared(name, __rlikeMatcher0))
                                {
