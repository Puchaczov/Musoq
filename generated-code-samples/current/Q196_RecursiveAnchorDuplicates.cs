...
Cte
  Definition [numbers]
    RecursiveCte [numbers] [FullRow]
      ...
      RecursiveMember
        MultiStatement
          Project [(n.Id + 1) as n.Id + 1]
            Filter [(n.Id < 2)]
              CteRef [numbers as n]
  Query
    MultiStatement
      Sort [numbers.Id]
        Project [numbers.Id as Id]
          CteRef [numbers as numbers]
*/
...
PhysicalCte
  Definition [numbers]
    PhysicalRecursiveCte [numbers] [FullRow]
      Anchor
      ...
      RecursiveMember
        PhysicalMultiStatement
          PhysicalProject [(n.Id + 1) as n.Id + 1]
            PhysicalFilter [(n.Id < 2)]
              PhysicalCteRef [numbers as n]
  Query
    PhysicalMultiStatement
      PhysicalSort [numbers.Id]
        PhysicalProject [numbers.Id as Id]
          PhysicalCteRef [numbers as numbers]
*/
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    RecursiveCte [numbers; result cte0; frontiers cte0CurrentFrontier, cte0NextFrontier; identity FullRow via cte0Seen (Id); max iterations 1000; max rows 10000000; max snapshot rows 10000000]
      Anchor
      ...
      RecursiveMember
        ForEach [n in cte0CurrentFrontier]
          If [(n.Id < 2)]
            RecursiveAppend [cte0NextFrontier <- Cte0Row0(Id: (n.Id + 1)); identity cte0Seen (Id); guard cte0.Count + cte0NextFrontier.Count < 10000000]
    ...
    PhaseBoundary [From]
    ForEach [numbers in _cteRowResults.Slot0]
      AppendShape [result <- ResultShape0(Id: numbers.Id)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q196_RecursiveAnchorDuplicates
{
    using System;
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                    ...
                    while (cte0CurrentFrontier.Count > 0)
                    {
                        ...
                        for (int cte0CurrentFrontierIndex = 0; cte0CurrentFrontierIndex < cte0CurrentFrontier.Count; ++cte0CurrentFrontierIndex)
                        {
                            ...
                            if ((n.Id < 2))
                            {
                                ...
                                var __cte0NextFrontierCandidate0 = (n.Id + 1);
                ...
                for (int __storedTable0Index = 0; __storedTable0Index < __storedTable0Rows.Count; ++__storedTable0Index)
                {
                    ...
                    Cte0Row0 numbers = __storedTable0Rows[__storedTable0Index];
                    result.Add(new ResultShape0(numbers.Id));
                }
