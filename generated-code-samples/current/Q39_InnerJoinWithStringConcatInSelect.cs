// === Parsed Query ===
/*
select a.Name + ' - ' + b.Country, b.Population from #A.entities() a inner join #A.entities() b on a.Id = b.Id
*/

// === Logical Plan ===
/*
MultiStatement
  Project [a.Name as a.Name, a.Id as a.Id, b.Country as b.Country, b.Population as b.Population, b.Id as b.Id]
    Join [Inner] [(a.Id = b.Id)]
      SchemaScan [#A.entities() as a]
      SchemaScan [#A.entities() as b]
  Project [((a.Name || ' - ') || b.Country) as a.Name +  -  + b.Country, b.Population as b.Population]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name, a.Id as a.Id, b.Country as b.Country, b.Population as b.Population, b.Id as b.Id]
    PhysicalHashJoin [Inner] [build: b.Id] [probe: a.Id]
      PhysicalSchemaScan [#A.entities() as a]
      PhysicalSchemaScan [#A.entities() as b]
  PhysicalProject [((a.Name || ' - ') || b.Country) as a.Name +  -  + b.Country, b.Population as b.Population]
...
ExecutionPlan [compiled]
  Shapes
    ...
    Generated [ResultRow0]
      a.Name +  -  + b.Country: string <- field a_Name_________b_Country
    ...
    ChunkedForEach [a in aRows]
      HashProbe [bHash[a.Id] -> bHashMatches]
        ForEach [b in bHashMatches]
          AppendShape [result <- ResultShape0(a.Name +  -  + b.Country: ((a.Name || ' - ') || b.Country), b.Population: b.Population)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q39_InnerJoinWithStringConcatInSelect
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        {
            new Column("a.Name +  -  + b.Country", typeof(string), 0),
        ...
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_b_1 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Country", typeof(string), 12), new Column("Population", typeof(decimal), 13), new Column("Id", typeof(int), 18) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_Name_________b_Country, __musoqShapeRow.b_Population);
            }
        }
                            ...
                            if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                            {
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    if (bHash.TryGetValue(key, out var bHashMatches))
                                    {
                                        ...
                                        {
                                            token.ThrowIfCancellationRequested();
                                            __musoqFinalShapeRows.Add(new ResultShape0(((a.Name + " - ") + b.Country), b.Population));
                                        }
                                    }
                                }
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            {
                a_Name_________b_Country = __value0;
                b_Population = __value1;
            }

            public override int Count => 2;
            public string a_Name_________b_Country { get; private set; }
            ...
            public override void AssignValue(int columnNumber, object value)
            {
                ...
                {
                    case 0:
                        a_Name_________b_Country = (string)value;
                        break;
                    case 1:
            ...
            {
                "a.Name +  -  + b.Country" => true,
                "a_Name_________b_Country" => true,
                "Country" => true,
                "b.Population" => true,
                "b_Population" => true,
                "Population" => true,
            ...
            {
                0 => (object)a_Name_________b_Country,
                1 => (object)b_Population,
                _ => throw new IndexOutOfRangeException()
            };
            public override object this[string name] => name switch
            {
                "a.Name +  -  + b.Country" => (object)a_Name_________b_Country,
                "a_Name_________b_Country" => (object)a_Name_________b_Country,
                "Country" => (object)a_Name_________b_Country,
                "b.Population" => (object)b_Population,
                "b_Population" => (object)b_Population,
                "Population" => (object)b_Population,
        ...
        {
            public ResultShape0(string a_Name_________b_Country, decimal b_Population)
            {
                this.a_Name_________b_Country = a_Name_________b_Country;
                this.b_Population = b_Population;
            }

            public string a_Name_________b_Country { get; }
