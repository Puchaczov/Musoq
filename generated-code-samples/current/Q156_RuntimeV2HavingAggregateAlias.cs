...
MultiStatement
  Project [ko3iko.City as ko3iko.City, AggRef(ko3iko.Count(*)) as ko3iko.Count(*)]
    Having [(AggRef(ko3iko.Count(*)) > 1)]
      Aggregate [keys: City] [aggs: Count(*)]
        SchemaScan [#features.items() as ko3iko]
  Project [ko3iko.City as City, ko3iko.Count(*) as cnt]
...
PhysicalMultiStatement
  PhysicalProject [ko3iko.City as ko3iko.City, AggRef(ko3iko.Count(*)) as ko3iko.Count(*)]
    PhysicalHaving [(AggRef(ko3iko.Count(*)) > 1)]
      PhysicalSingleKeyAggregate [key: City (String)] [aggs: Count(*)]
        PhysicalSchemaScan [#features.items() as ko3iko]
  PhysicalProject [ko3iko.City as City, ko3iko.Count(*) as cnt]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ForEach [finalGroup in groupsToFinalize]
      If [(ko3iko.Count(*) > 1)]
        AppendShape [result <- ResultShape0(City: finalGroup.City, cnt: ko3iko.Count(*))]
    ReturnDeferredTable [result: ResultRow0 <- ResultShape0]
*/

// === SyntaxTree:  ===
namespace GeneratedSample_Q156_RuntimeV2HavingAggregateAlias
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.City, __musoqShapeRow.cnt);
            }
        }
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static void ParallelSingleKeyAggregateChunk_0(IReadOnlyList<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity> chunk, Dictionary<string, ResultAggregateGroup> groups, List<ResultAggregateGroup> orderedGroups, ref ResultAggregateGroup nullGroup, CancellationToken cancellationToken)
        {
            for (var index = 0; index < chunk.Count; index++)
            {
                ...
                Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity ko3iko = chunk[index];
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        private static List<ResultAggregateGroup> ParallelSingleKeyAggregate_0(IEnumerable<IReadOnlyList<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity>> rows, int maxDegreeOfParallelism, CancellationToken cancellationToken)
        {
            ...
            Parallel.ForEach<IReadOnlyList<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity>, ParallelSingleKeyAggregateChunkWorker_0>(rows, options, () => new ParallelSingleKeyAggregateChunkWorker_0(cancellationToken), (chunk, _, worker) =>
            {
                worker.ProcessChunk(chunk ?? Array.Empty<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity>());
                return worker;
            }, worker =>
            {
        ...
        private sealed class ParallelSingleKeyAggregateChunkWorker_0
        {
            ...
            [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
            public void ProcessChunk(IReadOnlyList<Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2CastGroupingFeatureEntity> chunk)
            {
        ...
        {
            public ResultShape0(string City, long cnt)
            {
                this.City = City;
                this.cnt = cnt;
            }
