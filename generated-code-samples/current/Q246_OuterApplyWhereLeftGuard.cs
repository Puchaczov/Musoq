// === Parsed Query ===
/*
select i.Name as Name, n.Value as Value from #applyempty.items() i outer apply i.Numbers n where i.Name = 'empty'
*/
...
MultiStatement
  Project [i.Name as i.Name, i.Numbers as i.Numbers, n.Value as n.Value]
    Apply [Outer]
      SchemaScan [#applyempty.items() as i]
      PropertySource [i.Numbers as n] [apply: Cross] [type: Int32[]]
  Project [i.Name as Name, n.Value as Value]
    Filter [(i.Name = 'empty')]
      CteRef [in as in]
*/
...
PhysicalMultiStatement
  PhysicalProject [i.Name as i.Name, i.Numbers as i.Numbers, n.Value as n.Value]
    PhysicalNestedLoopApply [Outer] [guards: PreApplyRight: (i.Name = 'empty')]
      PhysicalSchemaScan [#applyempty.items() as i] [pushdown: (i.Name = 'empty')]
      PhysicalPropertySource [i.Numbers as n] [apply: Cross] [type: Int32[]]
  PhysicalProject [i.Name as Name, n.Value as Value]
    PhysicalFilter [(i.Name = 'empty')]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ForEach [in in _cteRowResults.Slot0]
      AppendShape [result <- ResultShape0(Name: in.i.Name, Value: in.n.Value)]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q246_OuterApplyWhereLeftGuard
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.Name, __musoqShapeRow.Value);
            }
        }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                for (int __storedTable0Index = 0; __storedTable0Index < __storedTable0Rows.Count; ++__storedTable0Index)
                {
                    ...
                    __musoqFinalShapeRows.Add(new ResultShape0(@in.i_Name, @in.n_Value));
                }
        ...
        {
            var __statement0_iSchema = provider.GetSchema("#applyempty");
        ...
        {
            public ResultShape0(string Name, int? Value)
            {
                this.Name = Name;
                this.Value = Value;
            }
