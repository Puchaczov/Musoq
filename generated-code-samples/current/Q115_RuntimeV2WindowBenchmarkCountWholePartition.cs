...
ExecutionPlan [compiled]
  ...
  Body
    ...
    ComputeCountWindowKernel[WholePartition] [resultCounts <- resultWindowRows value ko3iko.Name partition by ko3iko.Department]
...
namespace GeneratedSample_Q115_RuntimeV2WindowBenchmarkCountWholePartition
{
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IParameterizedRunnable
    {
        private static readonly Column[] __columns_compiled_result_1 = new Column[]
        {
            ...
            new Column("cnt", typeof(int), 2)
        };
        private static readonly IReadOnlyCollection<ISchemaColumn> __schemaColumns_compiled_ko3iko_0 = Array.AsReadOnly(new ISchemaColumn[] { new Column("Name", typeof(string), 1), new Column("Department", typeof(string), 7) });
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.Name, __musoqShapeRow.Department, __musoqShapeRow.cnt);
            }
        }
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                var resultCountsPartitionCountBuilder = new Musoq.Evaluator.Helpers.WindowPartitionCountBuilder<string>(resultWindowRows.Count);
                for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
                {
                    ...
                    resultCountsPartitionCountBuilder.AddReferenceUnchecked(ko3iko.Department, ko3iko.Name != null, windowIndex);
                }

                var resultCounts = resultCountsPartitionCountBuilder.ToResultInPlaceUnchecked();
                for (int windowIndex = 0; windowIndex < resultWindowRows.Count; ++windowIndex)
                {
                    ...
                    Musoq.Evaluator.Tests.Schema.RuntimeV2.RuntimeV2RegressionEntity ko3iko = resultWindowRows[windowIndex];
                    __musoqFinalShapeRows.Add(new ResultShape0(ko3iko.Name, ko3iko.Department, (int)resultCounts[windowIndex]));
                }
        ...
        {
            public ResultShape0(string Name, string Department, int cnt)
            {
                this.Name = Name;
