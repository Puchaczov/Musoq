...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name, a.Population as a.Population, b.Name as b.Name, b.Population as b.Population]
    PhysicalSortMergeJoin [Inner] [left: a.Population] [right: (b.Population + 950)] [op: >] [residual: (a.Population > (b.Population + 950))]
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    CreateRangeIndex [resultRangeIndex <- bRows by (bRangeCandidate.Population + 950) >]
    ChunkedForEach [a in aRows]
      RangeProbe [b <- resultRangeIndex where a.Population]
        If [(a.Population > (b.Population + 950))]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q76_NonEquiJoinSortMergeEnabled
{
    using System;
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    var resultRangeIndex = EvaluationHelper.CreateRangeJoinIndex<Musoq.Evaluator.Tests.Schema.Basic.BasicEntity, decimal>(bRows, (bRangeCandidate) => (bRangeCandidate.Population + 950), Musoq.Evaluator.IR.Expressions.BinaryOpKind.GreaterThan);
