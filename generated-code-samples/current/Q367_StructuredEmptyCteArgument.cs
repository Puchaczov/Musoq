  ...
  Query
    MultiStatement
      Project [n.Value as n.Value]
        SchemaScan [#inputs.numbers(CTE(empty)) as n]
*/
  ...
  Definition [empty]
    PhysicalMultiStatement
      PhysicalProject [p.Value as p.Value]
        PhysicalFilter [(p.Value < 0)]
          PhysicalValuesScan [1 rows as p]
  Query
    PhysicalMultiStatement
      PhysicalProject [n.Value as n.Value]
        PhysicalSchemaScan [#inputs.numbers(CTE(empty)) as n]
*/
...
ExecutionPlan [compiled]
  ...
  Body
    ...
    PhaseBoundary [From]
    CreateValuesRows [cte0_pRows: pValues5F43885BRow0 x 1]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q367_StructuredEmptyCteArgument
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        ...
        private IEnumerable<ResultShape0> ComputeShapeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            try
            {
                ...
                try
                {
                    Musoq.Examples.DataSources.StructuredInputs.NumbersSource nRowsSourceInstance = new Musoq.Examples.DataSources.StructuredInputs.NumbersSource(__musoqPrepareCte_f1644e8237d4b6bf(_cteRowResults.Slot0, token), nRowsSourceContext);
        ...
        private static int[] __musoqPrepareCte_f1644e8237d4b6bf(IReadOnlyList<Cte0Row0>? rows, CancellationToken token)
        {
            {
                token.ThrowIfCancellationRequested();
