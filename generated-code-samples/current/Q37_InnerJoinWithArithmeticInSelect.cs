// === Parsed Query ===
/*
select a.Name, a.Population * 2 from #A.entities() a inner join #A.entities() b on a.Id = b.Id
*/

// === Logical Plan ===
/*
MultiStatement
  Project [a.Name as a.Name, a.Population as a.Population, a.Id as a.Id, b.Id as b.Id]
    Join [Inner] [(a.Id = b.Id)]
      SchemaScan [#A.entities() as a]
      SchemaScan [#A.entities() as b]
  Project [a.Name as a.Name, (a.Population * 2) as a.Population * 2]
    CteRef [ab as ab]
*/
...
PhysicalMultiStatement
  PhysicalProject [a.Name as a.Name, a.Population as a.Population, a.Id as a.Id, b.Id as b.Id]
    PhysicalHashJoin [Inner] [build: b.Id] [probe: a.Id]
      PhysicalSchemaScan [#A.entities() as a]
      PhysicalSchemaScan [#A.entities() as b]
  PhysicalProject [a.Name as a.Name, (a.Population * 2) as a.Population * 2]
...
ExecutionPlan [compiled]
  Shapes
    ...
    Generated [ResultRow0]
      ...
      a.Population * 2: decimal <- field a_Population___2
    ...
    ChunkedForEach [a in aRows]
      HashProbe [bHash[a.Id] -> bHashMatches]
        ForEach [b in bHashMatches]
          AppendShape [result <- ResultShape0(a.Name: a.Name, a.Population * 2: (a.Population * 2))]
...
// === SyntaxTree:  ===
namespace GeneratedSample_Q37_InnerJoinWithArithmeticInSelect
{
    using System;
    ...
    public sealed class CompiledQuery : BaseOperations, ITableRunnable, IQueryProgressSource, IParameterizedRunnable
    {
        private static readonly Column[] __columns_compiled_result_2 = new Column[]
        {
            ...
            new Column("a.Population * 2", typeof(decimal), 1)
        };
        ...
        private IEnumerable<ResultRow0> ComputeRows_compiled_0(ISchemaProvider provider, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> sourceRuntimeSettingsBySourceContextId, IReadOnlyDictionary<string, SourceExecutionPlan> sourceExecutionPlans, ILogger logger, CancellationToken token)
        {
            ...
            {
                yield return new ResultRow0(__musoqShapeRow.a_Name, __musoqShapeRow.a_Population___2);
            }
        }
                            ...
                            if (aChunkView.Source is Musoq.Evaluator.Tests.Schema.Basic.BasicEntity[] aChunkViewArray)
                            {
                                ...
                                for (int aIndex = 0, aIndexCount = aChunkView.Count; aIndex < aIndexCount; ++aIndex)
                                {
                                    ...
                                    if (bHash.TryGetValue(key, out var bHashMatches))
                                    {
                                        ...
                                        {
                                            token.ThrowIfCancellationRequested();
                                            __musoqFinalShapeRows.Add(new ResultShape0(a.Name, (a.Population * 2)));
                                        }
                                    }
                                }
        ...
        private sealed class ResultRow0 : Row
        {
            ...
            {
                a_Name = __value0;
                a_Population___2 = __value1;
            }

            public override int Count => 2;
            public string a_Name { get; private set; }
            public decimal a_Population___2 { get; private set; }
            ...
            public override void AssignValue(int columnNumber, object value)
            {
                switch (columnNumber)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        a_Population___2 = (decimal)value;
                        break;
                    default:
            ...
            public override object this[string name] => name switch
            {
                ...
                "Name" => (object)a_Name,
                "a.Population * 2" => (object)a_Population___2,
                "a_Population___2" => (object)a_Population___2,
                "Population * 2" => (object)a_Population___2,
        ...
        {
            public ResultShape0(string a_Name, decimal a_Population___2)
            {
                this.a_Name = a_Name;
                this.a_Population___2 = a_Population___2;
            }

            public string a_Name { get; }
            public decimal a_Population___2 { get; }
        }
    }
}
