...
public enum DiagnosticCode
{
    ...
    MQ2042_InvalidEnumDeclaration = 2042,
    MQ2043_InvalidEnumBackingType = 2043,
    MQ2044_MissingEnumMemberValue = 2044,
    MQ2045_DuplicateEnumMember = 2045,
    MQ2046_EnumMemberValueOutOfRange = 2046,
    MQ2047_EmptyEnumDeclaration = 2047,
    MQ2048_UnsupportedEnumSyntax = 2048,
    ...
    MQ3099_WindowOrderByRequired = 3099,
    MQ3100_NestedWindowFunction = 3100,
    MQ3101_WindowFunctionInFilter = 3101,
    MQ3102_InvalidStatementOrder = 3102,
    MQ3103_InvalidWindowFunctionArgument = 3103,
    MQ3104_UnknownNamedWindow = 3104,
    MQ3105_DuplicateNamedWindow = 3105,
    MQ3106_DuplicateEnumType = 3106,
    MQ3107_UnknownEnumType = 3107,
    MQ3108_UnknownEnumMember = 3108,
    MQ3109_EnumIdentityMismatch = 3109,
    MQ3110_UnsupportedEnumOperator = 3110,
    MQ3111_InvalidEnumHelper = 3111,
    MQ3112_UnsupportedEnumScriptParameter = 3112,
