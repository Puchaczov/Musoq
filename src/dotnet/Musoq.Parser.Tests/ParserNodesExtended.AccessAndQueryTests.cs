...
/// </summary>
[TestClass]
public class ParserNodesExtendedAccessAndQueryTests
{
    ...
    public void AccessMethodNode_ChangeMethod_UpdatesMethod()
    {
        ...
        var method = typeof(string).GetMethod("ToUpper", Type.EmptyTypes) ??
                     throw new InvalidOperationException("string.ToUpper() was not found.");
    ...
    [TestMethod]
    public void QueryScope_ToString_ReturnsEmptyStringForEmptyScope()
    {
        var scope = new QueryScope([]);
