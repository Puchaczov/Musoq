...
public class NegativeTestsBase
{
    ...
    [
        new()
        {
            Id = 1, Name = "Alice", Age = 25, City = "London", Salary = 50000m, BirthDate = new DateTime(1999, 1, 15),
            ManagerId = null, Email = "alice@test.com"
        },
        new()
        {
            Id = 2, Name = "Bob", Age = 35, City = "Paris", Salary = 60000m, BirthDate = new DateTime(1989, 6, 20),
            ManagerId = 1, Email = "bob@test.com"
        },
        new()
        {
            Id = 3, Name = "Charlie", Age = 28, City = "London", Salary = 55000m, BirthDate = new DateTime(1996, 3, 10),
            ManagerId = 1, Email = "charlie@test.com"
        },
        new()
        {
            Id = 4, Name = "Diana", Age = 42, City = "Berlin", Salary = 75000m, BirthDate = new DateTime(1982, 11, 5),
            ManagerId = 2, Email = "diana@test.com"
        },
        new()
        {
            Id = 5, Name = "Eve", Age = 31, City = "Paris", Salary = 62000m, BirthDate = new DateTime(1993, 8, 25),
            ManagerId = 2, Email = "eve@test.com"
        }
    ];
    ...
    [
        new()
        {
            OrderId = 100, PersonId = 1, Amount = 250.50m, Status = "Completed", OrderDate = new DateTime(2024, 1, 10),
            Notes = "First order"
        },
        new()
        {
            OrderId = 101, PersonId = 1, Amount = 150.00m, Status = "Pending", OrderDate = new DateTime(2024, 2, 15),
            Notes = null
        },
        new()
        {
            OrderId = 102, PersonId = 2, Amount = 500.00m, Status = "Completed", OrderDate = new DateTime(2024, 1, 20),
            Notes = "Rush delivery"
        },
        new()
        {
            OrderId = 103, PersonId = 3, Amount = 75.25m, Status = "Cancelled", OrderDate = new DateTime(2024, 3, 5),
            Notes = null
        },
        new()
        {
            OrderId = 104, PersonId = 5, Amount = 1200.00m, Status = "Completed", OrderDate = new DateTime(2024, 2, 28),
            Notes = "Bulk order"
        }
    ];
    ...
    [
        new()
        {
            Id = 1, Name = "Solo", Age = 30, City = "Tokyo", Salary = 70000m, BirthDate = new DateTime(1994, 5, 12),
            ManagerId = null, Email = "solo@test.com"
        }
    ];
