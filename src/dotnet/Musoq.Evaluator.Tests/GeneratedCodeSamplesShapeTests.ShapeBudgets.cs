...
public sealed partial class GeneratedCodeSamplesShapeTests
{
    ...
    [
        ...
        new(CrossApplyWhereLeftGuardSampleFileName, "i"),
        new(ChainedCrossApplyScopedGuardsSampleFileName, "i"),
        new(ChainedCrossApplyResidualPredicateSampleFileName, "i"),
        new(OuterApplyWhereLeftGuardSampleFileName, "i"),
        new(CrossApplyMethodWhereLeftGuardSampleFileName, "i"),
