...
/// </summary>
[TestClass]
public class BinaryOrTextualInterpretationEvaluatorTests
{
    ...
    /// </summary>
    private class BinaryEntityTable : ISchemaTable
    {
    ...
    /// </summary>
    private class TextEntityTable : ISchemaTable
    {
        public ISchemaColumn[] Columns =>
        [
    ...
    /// </summary>
    private class BinarySchema : SchemaBase
    {
    ...
    /// </summary>
    private class TextSchema : SchemaBase
    {
        private static readonly Lazy<MethodsAggregator> CachedLibrary = new(CreateLibrary);
    ...
    /// </summary>
    private class BinarySchemaProvider : ISchemaProvider
    {
    ...
    /// </summary>
    private class TextSchemaProvider : ISchemaProvider
    {
