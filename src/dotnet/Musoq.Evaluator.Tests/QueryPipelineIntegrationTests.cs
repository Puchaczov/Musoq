...
/// <summary>
///     Integration tests for end-to-end query compilation and execution.
/// </summary>
[TestClass]
public class QueryPipelineIntegrationTests : BasicEntityTestBase
{
    [TestMethod]
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithLike_ShouldWork()
    {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithIn_ShouldWork()
    {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithSkipTake_ShouldWork()
    {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithSingleStringConcat_ShouldWork()
    {
        var query = "select Name + City from #A.Entities()";
        var sources = new Dictionary<string, IEnumerable<BasicEntity>>
        {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithNot_ShouldWork()
    {
        var query = "select Name from #A.Entities() where Name <> 'Test1'";
        var sources = new Dictionary<string, IEnumerable<BasicEntity>>
        {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithGreaterThan_ShouldWork()
    {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithIsNull_ShouldWork()
    {
    ...
    [TestMethod]
    public void QueryPipeline_SelectWithCoalesce_ShouldWork()
    {
