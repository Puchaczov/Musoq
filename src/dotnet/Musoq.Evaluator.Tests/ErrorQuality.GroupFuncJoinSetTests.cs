...
/// </summary>
[TestClass]
public class ErrorQualityGroupFuncJoinSetTests : BasicEntityTestBase
{
    #region Test Setup
...
SELECT Name FROM #B.Entities()";
    ...
    [TestMethod]
    public void E_SET_05_EmptyColumnListInSetOperation_ShouldBeValid()
    {
...
SELECT Name FROM #B.Entities()";
        ...
        // Assert — empty key list compares all projected fields
        AssertNoErrors(result);
    }
