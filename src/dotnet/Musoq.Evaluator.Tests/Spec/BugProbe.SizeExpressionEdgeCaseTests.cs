...
/// </summary>
[TestClass]
public class BugProbeSizeExpressionEdgeCaseTests
{
    ...
    public void Binary_UintSizeRefSmallValue_ShouldWorkForStringField()
    {
        ...
        var query = @"
            ...
            cross apply Interpret<Pkt>(b.Content) p";
    ...
    public void Binary_UshortSizeRefForByteArray_ShouldWork()
    {
        ...
        var query = @"
            ...
            cross apply Interpret<Chunk>(b.Content) c";
    ...
    public void Binary_ShortSizeRefNegativeValue_ShouldThrowParseException()
    {
        ...
        var query = @"
            ...
            cross apply Interpret<Broken>(f.Content) b";
        ...
        var ex = Assert.Throws<ParseException>(() =>
            _ = vm.Run(CancellationToken.None).Count);
    ...
    public void Binary_ExpressionSizeMinusOne_ShouldWork()
    {
        ...
        var query = @"
            ...
            cross apply Interpret<Msg>(b.Content) m";
    ...
    public void Binary_ExpressionSizeMultiply_ShouldWork()
    {
        ...
        bw.Write("ABCDEF"u8.ToArray()); // 3*2 = 6 chars
        bw.Flush();
