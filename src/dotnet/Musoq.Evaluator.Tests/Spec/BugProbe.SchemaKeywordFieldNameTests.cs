...
/// </summary>
[TestClass]
public class BugProbeSchemaKeywordFieldNameTests
{
    ...
    public void Binary_FieldNameAt_ShouldParse()
    {
        var query = @"
            ...
            cross apply Interpret<Rec>(b.Content) r";
    ...
    public void Binary_FieldNameLower_ShouldParse()
    {
        var query = @"
            ...
            cross apply Interpret<Bounds>(f.Content) b";
    ...
    public void Binary_FieldNameCapture_ShouldParse()
    {
        var query = @"
            ...
            cross apply Interpret<Frame>(b.Content) f";
