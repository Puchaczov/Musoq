...
[TestClass]
public class MethodsMetadataResolutionAndOrderingTests : MethodsMetadataTestBase
{
    private MethodsMetadata _genericResolution = CreateMethodsMetadataFor<GenericResolutionMethods>();
    private MethodsMetadata _typeCompatibility = CreateMethodsMetadataFor<TypeCompatibilityMethods>();
    private MethodsMetadata _ordering = CreateMethodsMetadataFor<OrderingMethods>();
    ...
    private sealed class GenericResolutionMethods
    {
    ...
    [SuppressMessage("ReSharper", "UnusedParameter.Local")]
    private sealed class TypeCompatibilityMethods
    {
    ...
    private sealed class MoreSpecific : Specific;

    [SuppressMessage("ReSharper", "UnusedParameter.Local")]
    private sealed class OrderingMethods
    {
