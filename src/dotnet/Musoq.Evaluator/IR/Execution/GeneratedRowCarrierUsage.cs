...
using System.Linq;
using GeneratedRowContextConstructor = Musoq.Evaluator.IR.Execution.ExecutionCSharpRenderer.GeneratedRowContextConstructor;
    ...
    private static void AddNodeVariables(ExecutionNode node, Dictionary<string, HashSet<string>> aliases)
    {
        switch (node)
        {
            ...
            case ExecutionParallelFilterProjectLoop loop:
                ...
                AddVariable(loop.SerialLoop.Item, aliases);
                break;
