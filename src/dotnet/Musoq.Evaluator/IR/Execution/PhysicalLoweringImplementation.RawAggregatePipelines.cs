...
internal sealed partial class PhysicalLoweringImplementation
{
    ...
    private static AggregateSingleKeyPipeline? DecomposeRawSingleKeyAggregatePipeline(PhysicalNode node)
    {
        return node switch
        {
    ...
    private static AggregateSingleKeyPipeline? CreateRawSingleKeyAggregatePipeline(
        ...
        IrExpression? havingPredicate)
    {
        ...
        return source == null
            ? null
            : new AggregateSingleKeyPipeline(
                CreateAggregateProjection(aggregate),
                aggregate,
                aggregate.Bindings,
                source,
