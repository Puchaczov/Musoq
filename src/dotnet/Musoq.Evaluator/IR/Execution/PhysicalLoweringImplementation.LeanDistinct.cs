...
{
    private static bool CanUseLeanDistinct(AggregateSingleKeyPipeline pipeline)
    {
        ...
        bool scopeDistinctVariables)
    {
        ...
        var distinctSet = CreateLeanDistinctSetVariable(resultTableName, scopeDistinctVariables, distinctKey.ReturnType.ResolveClrType());
        ...
        nodes.Add(new ExecutionCreateKeySet(distinctSet, distinctKey.ReturnType.ResolveClrType(), CreateRowsCapacityCandidate(distinctSet, loop.Source)));
        nodes.Add(loop);
        ...
        ExecutionAppendRow appendRow)
    {
        var addCall = new ExecutionMethodCall(
            GetHashSetAddMethod(distinctKey.ReturnType.ResolveClrType()),
            [distinctKey],
            null,
            typeof(bool),
            null,
