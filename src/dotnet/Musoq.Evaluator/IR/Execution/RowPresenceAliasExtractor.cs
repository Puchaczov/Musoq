...
internal sealed partial class RowPresenceAliasExtractor : IrExpressionVisitor<IReadOnlyList<string>>
{
    ...
    {
        var extractor = new RowPresenceAliasExtractor();
    ...
    protected override IReadOnlyList<string> VisitColumnRef(ColumnRef node) => _aliases.ToArray();
