...
public sealed partial class ExecutionCSharpRenderer
{
        ...
        ExecutionRenderContext context)
    {
        ...
        var arguments = new List<ExpressionSyntax>
        {
            ...
            CreateAsOfKeySelector(createIndex.CandidateKey, candidateName, createIndex.ComparisonKeyType, context),
            CreateBinaryOpKindExpression(createIndex.ComparisonKind)
        };
        if (createIndex.TieBreak != null)
        {
            arguments.Add(CreateAsOfKeySelector(createIndex.TieBreak.Key, candidateName, createIndex.TieBreak.Key.ReturnType, context));
        ...
        ExecutionRenderContext context)
    {
        ...
        if (asOfProbe.TieBreak != null)
        {
            arguments.Add(CreateAsOfKeySelector(asOfProbe.TieBreak.Key, candidateName, asOfProbe.TieBreak.Key.ReturnType, context));
        ...
        ExecutionRenderContext context)
    {
        return SyntaxFactory.InvocationExpression(
            ...
            .WithArgumentList(CreateArgumentList(
                ...
                CreateAsOfComparisonKeyExpression(asOfProbe.ProbeKey, asOfProbe.ComparisonKeyType ?? typeof(object), context)));
    }
