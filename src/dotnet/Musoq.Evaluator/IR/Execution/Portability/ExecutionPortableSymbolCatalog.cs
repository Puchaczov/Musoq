...
internal static class ExecutionPortableSymbolCatalog
{
    ...
    private static readonly IReadOnlySet<Type> HostImportTypes = new HashSet<Type>
    {
        ...
        typeof(ISchema),
        typeof(IQueryScopedRowSourceSchema),
        typeof(IQuerySourceFieldReader),
        typeof(IQueryRowMaterializer<>),
        typeof(QueryScopedRowSourceRequest),
        typeof(QueryRowShape),
        typeof(QueryRowField),
        typeof(ISchemaTable),
