...
public sealed partial class ExecutionCSharpRenderer
{
        ...
        ExpressionSyntax[] arguments)
    {
        ...
        var sourceType = sourceScan.Binding.SourceType ?? sourceScan.Source.Type;
    ...
    {
        return fields
            .Select(field => new SchemaColumn(field.Name, field.OutputIndex, field.Type, field.ReadModifiers))
            .ToArray();
    }
