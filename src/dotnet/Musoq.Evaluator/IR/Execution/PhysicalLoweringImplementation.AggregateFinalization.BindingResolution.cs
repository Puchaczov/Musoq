...
{
    private static LoweringAttempt<ExecutionExpression> CreateAggregateFinalCall(
        string? identifier,
        ...
        AggregateFinalizationContext context)
    {
        ...
        return LoweringAttempt<ExecutionExpression>.Built(new ExecutionAggregateCall(
            context.Group,
            binding.GetMethod,
            arguments,
