...
{
    private LocalDeclarationStatementSyntax RenderCreateRecordList(ExecutionCreateRecordList createList)
    {
        var argumentList = createList.CapacityHint == null
            ? SyntaxFactory.ArgumentList()
            : CreateArgumentList(RenderCapacityHint(createList.CapacityHint));
