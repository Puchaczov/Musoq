...
public sealed partial class PhysicalToExecutionPlanBuilder
{
    ...
    private static SupportedPipeline? DecomposeSupportedPipeline(PhysicalNode node)
    {
        ...
        return new SupportedPipeline(project, source.Source, source.Filter, CreatePostOperations(operations, project.Fields));
    }
