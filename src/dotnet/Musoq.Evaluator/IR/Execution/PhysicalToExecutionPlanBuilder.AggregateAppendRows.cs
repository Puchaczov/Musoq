...
public sealed partial class PhysicalToExecutionPlanBuilder
{
    ...
    private static BuildResult<ExecutionAppendRow> CreateAggregateAppendRow(
        ExecutionVariable resultTable,
        GeneratedRowShape resultShape,
        ...
        AggregateFinalizationContext context)
    {
        ...
        foreach (var field in fields)
        {
            ...
            if (!value.Supported)
                return BuildResult<ExecutionAppendRow>.Unsupported(
    ...
    private static BuildResult<ExecutionAppendRow> CreateGroupedAggregateAppendRow(
        ExecutionVariable resultTable,
        GeneratedRowShape resultShape,
        ProjectedField[] fields,
        AggregateFinalizationContext context)
