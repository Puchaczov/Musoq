...
{
    private LoweringAttempt<ProjectedField[]> CreateNestedSourceProjectionFields(
        PhysicalNode source,
        ...
        IReadOnlyDictionary<string, GeneratedRowShape>? cteShapesByName)
    {
        ...
        if (!collection.IsBuilt)
            return LoweringAttempt<ProjectedField[]>.Unsupported(collection.UnsupportedReason);

        return LoweringAttempt<ProjectedField[]>.Built(fields.ToArray());
    }
