...
internal sealed partial class PhysicalLoweringImplementation
{
        ...
        ExecutionAsOfProbe probe)
    {
        ...
        return new ExecutionCreateAsOfIndex(
            ...
            probe.ComparisonKeyType?.ResolveClrType() ?? typeof(object),
            probe.TieBreak);
    }
        ...
        ExecutionBlock? noMatchBody)
    {
        ...
        return new ExecutionAsOfProbe(
            ...
            body,
            noMatchBody,
            ComparisonKeyType: ExecutionClrBindingFactory.FromClr(ResolveAsOfComparisonKeyType(probeKey.ReturnType.ResolveClrType(), candidateKey.ReturnType.ResolveClrType())),
