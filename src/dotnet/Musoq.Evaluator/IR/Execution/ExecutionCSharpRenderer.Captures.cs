...
public sealed partial class ExecutionCSharpRenderer
{
    ...
    {
        return new CapturedLocal(variable.Name, variable.Type, variable.GeneratedRowTypeName);
    }
    ...
    {
        if (!string.IsNullOrWhiteSpace(capture.GeneratedRowTypeName) && capture.Type == typeof(IReadOnlyList<Musoq.Evaluator.Tables.Row>))
