    ...
    private PhysicalNode Lower(LogicalNode node, PhysicalStrategyPlan strategyPlan)
    {
        return node switch
        {
            SchemaScanNode scan => new PhysicalSchemaScanNode(
                ...
                scan.SourceConstructorStableId, scan.SourceConstructor, scan.StructuralArgumentLimits),
            ...
            DescNode desc => new PhysicalDescNode(desc.SchemaName, desc.MethodName, desc.Type, desc.Column, desc.Arguments, desc.SourceContextId, desc.OutputSchema, desc.QueryOutputSchema, desc.ColumnSpan, desc.ArgumentDescriptions),
