...
public class GenericSchemaProvider<TEntity, TTable>(
    IDictionary<string, IEnumerable<IReadOnlyList<TEntity>>> values,
    IDictionary<string, int> nameToIndexMap,
    IDictionary<int, Func<TEntity, object?>> indexToObjectAccessMap) : ISchemaProvider
{
