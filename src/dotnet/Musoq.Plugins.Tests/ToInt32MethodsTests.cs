...
public class ToInt32MethodsTests : LibraryBaseBaseTests
{
    ...
    {
        var result = Library.ToInt32(123.7f);
    ...
    {
        var result = Library.ToInt32(456.2);
        Assert.AreEqual(456, result);
    }
    ...
    {
        var result = Library.ToInt32(789.9m);
    ...
    {
        var result = Library.ToInt32(true);
        Assert.AreEqual(1, result);

        result = Library.ToInt32(false);
