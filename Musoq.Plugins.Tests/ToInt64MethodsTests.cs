...
public class ToInt64MethodsTests : LibraryBaseBaseTests
{
    ...
    {
        var result = Library.ToInt64(2147483647);
    ...
    {
        var result = Library.ToInt64(-2147483648);
    ...
    {
        var result = Library.ToInt64(4294967295);
    ...
    {
        var result = Library.ToInt64(1234567890123456789L);
    ...
    {
        var result = Library.ToInt64(9223372036854775807UL);
        Assert.AreEqual(9223372036854775807L, result);
    }
    ...
    {
        var result = Library.ToInt64(123456.7f);
    ...
    {
        var result = Library.ToInt64(987654321.9);
    ...
    {
        var result = Library.ToInt64(123456789.8m);
    ...
    {
        var result = Library.ToInt64(true);
        Assert.AreEqual(1L, result);

        result = Library.ToInt64(false);
    ...
    {
        var result = Library.ToInt64(int.MaxValue);
        Assert.AreEqual(int.MaxValue, result);

        result = Library.ToInt64(uint.MaxValue);
    ...
    {
        var result = Library.ToInt64(int.MinValue);
        Assert.AreEqual(int.MinValue, result);

        result = Library.ToInt64(sbyte.MinValue);
