...
Enumerate bases from Airtable API
...
| --- | --- | --- |
| MUSOQ_AIRTABLE_API_KEY | true | Airtable API key |
...
| PermissionLevel | string | Base description |

### airtable.base()

Enumerate base tables for Airtable API
...
| --- | --- | --- |
| MUSOQ_AIRTABLE_API_KEY | true | Airtable API key |
| MUSOQ_AIRTABLE_BASE_ID | true | Airtable base id |
...
| Id | string | Base id |
| Name | string | Base name |
| PrimaryFieldId | string | Base description |

### airtable.records(string tableName)

Enumerate records for specific table
