...
### flat.file(string path)

Gives ability to process flat files


| Name | Type | Description |
| ---- | ---- | ----------- |
| LineNumber | int | Line number of a given file |
| Line | string | Line of a given file |
