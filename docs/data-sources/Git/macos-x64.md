...
### IEnumerable\<Musoq.DataSources.Git.Entities.DifferenceEntity\> DifferenceBetween(Musoq.DataSources.Git.Entities.CommitEntity first, Musoq.DataSources.Git.Entities.CommitEntity second)

Gets the differences between two commits.

### IEnumerable\<Musoq.DataSources.Git.Entities.DifferenceEntity\> DifferenceBetween(Musoq.DataSources.Git.Entities.BranchEntity first, Musoq.DataSources.Git.Entities.BranchEntity second)

Gets the differences between two branches.

### IEnumerable\<Musoq.DataSources.Git.Entities.DifferenceEntity\> DifferenceBetweenCurrentAndBranch(Musoq.DataSources.Git.Entities.BranchEntity branch)

Gets the differences between the current branch and a specified branch.

### IEnumerable\<Musoq.DataSources.Git.Entities.DifferenceEntity\> DifferenceBetweenCommitAndBranch(Musoq.DataSources.Git.Entities.CommitEntity commit, Musoq.DataSources.Git.Entities.BranchEntity branch)

Gets the differences between a commit and a branch.

### IEnumerable\<Musoq.DataSources.Git.Entities.DifferenceEntity\> DifferenceBetweenBranchAndCommit(Musoq.DataSources.Git.Entities.BranchEntity branch, Musoq.DataSources.Git.Entities.CommitEntity commit)

Gets the differences between a branch and a commit.

### Musoq.DataSources.Git.Entities.CommitEntity CommitFrom(string sha)

Gets a commit entity from a SHA.

### Musoq.DataSources.Git.Entities.BranchEntity BranchFrom(string canonicalName)
