...
### string Sha256File(IO.FileInfo file)
...
### Musoq.DataSources.Os.Files.ExtendedFileInfo? GetFileInfo(string fullPath)

Gets the file info

### Musoq.DataSources.Os.Files.ExtendedFileInfo GetExtendedFileInfo()
...
### IReadOnlyList\<Musoq.DataSources.Os.Files.ExtendedFileInfo\>? AggregateFiles(string name)

Gets the aggregated average value from the given group name

### IReadOnlyList\<IO.DirectoryInfo\>? AggregateDirectories(string name)
