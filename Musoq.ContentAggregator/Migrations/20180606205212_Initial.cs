        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagingName = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserScriptId = table.Column<Guid>(nullable: false),
                    RefreshedAt = table.Column<DateTimeOffset>(nullable: false),
                    ScriptId = table.Column<Guid>(nullable: false),
                    ShowAt = table.Column<int>(nullable: false),
                    UserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserScripts", x => x.UserScriptId);
                    table.ForeignKey(
