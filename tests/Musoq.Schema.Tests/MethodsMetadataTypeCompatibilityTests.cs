...
public class MethodsMetadataTypeCompatibilityTests
{
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("BoolMethod", [typeof(bool)], _entityType, out _),
            "bool -> bool should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("ShortMethod", [typeof(bool)], _entityType, out _),
            "bool -> short should not work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("IntMethod", [typeof(bool)], _entityType, out _),
            "bool -> int should not work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("LongMethod", [typeof(bool)], _entityType, out _),
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("ShortMethod", [typeof(short)], _entityType, out _),
            "short -> short should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("BoolMethod", [typeof(short)], _entityType, out _),
            "short -> bool should not work");
        Assert.IsTrue(_methodsMetadata.TryGetMethod("IntMethod", [typeof(short)], _entityType, out _),
            "short -> int should work");
        Assert.IsTrue(_methodsMetadata.TryGetMethod("LongMethod", [typeof(short)], _entityType, out _),
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("IntMethod", [typeof(int)], _entityType, out _),
            "int -> int should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("ShortMethod", [typeof(int)], _entityType, out _),
            "int -> short should not work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("BoolMethod", [typeof(int)], _entityType, out _),
            "int -> bool should not work");
        Assert.IsTrue(_methodsMetadata.TryGetMethod("LongMethod", [typeof(int)], _entityType, out _),
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("LongMethod", [typeof(long)], _entityType, out _),
            "long -> long should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("IntMethod", [typeof(long)], _entityType, out _),
            "long -> int should not work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("ShortMethod", [typeof(long)], _entityType, out _),
            "long -> short should not work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("BoolMethod", [typeof(long)], _entityType, out _),
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("DateTimeOffsetMethod", [typeof(DateTimeOffset)], _entityType,
            out _));
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("StringMethod", [typeof(string)], _entityType, out _),
            "string -> string should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("StringMethod", [typeof(object)], _entityType, out _),
            "object -> string should not work");

        Assert.IsTrue(_methodsMetadata.TryGetMethod("DecimalMethod", [typeof(decimal)], _entityType, out _),
            "decimal -> decimal should work");
        Assert.IsFalse(_methodsMetadata.TryGetMethod("DecimalMethod", [typeof(double)], _entityType, out _),
    ...
    {
        Assert.IsTrue(_methodsMetadata.TryGetMethod("BaseClassMethod", [typeof(Animal)], _entityType, out _),
            "Animal -> Animal should work");
        Assert.IsTrue(_methodsMetadata.TryGetMethod("BaseClassMethod", [typeof(Dog)], _entityType, out _),
